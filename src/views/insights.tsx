...
export default function Insights() {
  return (
    <>
      <PageSEO
        title="Insights — Applied AI, Systems Architecture & Deployment"
        description="Expert analysis on AI deployment, intelligent infrastructure, systems architecture, and operational intelligence for technology and institutional leaders."
        path="/insights"
      />
      ...
      <article className="pt-24 pb-0 min-h-screen bg-background">
        <div className="container mx-auto px-6 md:px-12">
          ...
          >
            ...
            <p className="text-base text-muted-foreground leading-relaxed">
              Briefings on AI deployment, systems architecture, and intelligent infrastructure engineering for technology and institutional leaders.
            </p>
          </motion.header>
        ...
        <CTASection
          title="Stay informed on applied AI and infrastructure."
          description="Our team publishes on AI deployment, systems architecture, and intelligent infrastructure engineering."
