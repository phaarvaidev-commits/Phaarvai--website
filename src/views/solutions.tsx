...
export default function Solutions() {
  return (
    <>
      <PageSEO
        title="Solutions — Applied AI, Intelligent Automation & Infrastructure Systems"
        description="Production-grade AI systems, intelligent automation, data platforms, and infrastructure monitoring — built for enterprise and institutional deployment."
        path="/solutions"
      />
        ...
        <div className="container mx-auto px-6 md:px-12">
          ...
          >
            ...
            <p className="text-base text-muted-foreground leading-relaxed">
              Production-grade AI systems and intelligent infrastructure — from architecture through deployment and operations.
            </p>
          </motion.header>
