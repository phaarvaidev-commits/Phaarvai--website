...
export const sectorSlugs: Record<string, string> = {
  ...
  "Energy": "energy",
  "Enterprise & Institutions": "enterprise",
  "Regional Digital Infrastructure": "regional-infrastructure",
...
export default function Sectors() {
  ...
  return (
    <>
      <PageSEO
        title="Sectors — Government, Infrastructure, Energy, Enterprise & Defense"
        description="Phaarvai operates across government, critical infrastructure, energy, enterprise, regional digital infrastructure, and defense — where operational data and AI systems hold strategic value."
        path="/sectors"
      />
      ...
      <article className="pt-24 pb-12 bg-background">
        ...
        <CTASection
          ...
          description="Whether navigating government procurement or infrastructure compliance, we build systems that meet rigorous operational standards."
          buttonLabel="View Capabilities"
          buttonHref="/capabilities"
          secondaryLabel="Contact Our Team"
          secondaryHref="/partner#contact"
        />
      </article>
    </>
  );
